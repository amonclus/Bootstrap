...
def render_wtm_animation_tab(graph: nx.Graph, config: SidebarConfig) -> None:
    st.subheader("WTM Cascade Animation")
    ...
    if st.button("▶ Run simulation" if large else "▶ Animate cascade", key="wtm_run_anim"):
