...
def render_h3_animation_tab(graph: nx.Graph, config: SidebarConfig) -> None:
    st.subheader("H3 Probabilistic Threshold Hybrid — Cascade Animation")
    ...
    if st.button("▶ Run simulation" if large else "▶ Animate cascade", key="h3_run_anim"):
