...
def render_h4_animation_tab(graph: nx.Graph, config: SidebarConfig) -> None:
    st.subheader("H4 Hybrid Cascade Animation")
    ...
    if st.button("▶ Run simulation" if large else "▶ Animate cascade", key="h4_run_anim"):
